...
=================================================================================================================================================================================================================================================================================
# Dataset 3 School diversity from 1994-2017
...
Cleaning and tidying dataset. The racial groups are already represented in percentage for each school. NA values are assumed to be 0. All percentage will be rounded to the nearest tenth value.
```{r}
df3_tidy<- df3 %>%
...
```
## Data analysis:
Overall distribution of ethnicity
Asian and AIAN groups seem to be the most under integrated among different schools.
```{r}
ggplot(df3_tidy, aes(x=Student_percentage, fill=Ethnicity)) +
  geom_histogram(binwidth = 5, position='dodge') +
  labs(y='frequency',
       title = 'Frequency distribution of students ethnicity',
       subtitle = 'Counted by student percentage')
```
### In 2016-2017, which states have schools have integrated the most Asian and AIAN students?
```{r}
df3_2017<- df3_tidy %>%
...
ggplot(df3_2017, aes(x=reorder(ST, -mean_percentage), y=mean_percentage, fill= Ethnicity)) +
  ...
  labs(title = 'Year 2016-2017 states with at least 50% AIAN or Asian integration in schools',
       x='States',
